...
import study.qeurydslex.dto.MemberDto;
import study.qeurydslex.dto.QMemberDto;
import study.qeurydslex.dto.UserDto;
import study.qeurydslex.entity.Member;
import study.qeurydslex.entity.QMember;
import study.qeurydslex.entity.QTeam;
import study.qeurydslex.entity.Team;
...
import static study.qeurydslex.entity.QMember.member;
import static study.qeurydslex.entity.QTeam.*;
...
*/
    ...
    public void fetchJoinNo() {
        ...
        //getPersistenceUnitUtil.isLoaded = 초기화가 된 엔티티인지 알려주는 펑션
   ...
   @Test
    public void findDtoByJPQL() {
       List<MemberDto> result = em.createQuery("select new study.qeurydslex.dto.MemberDto(m.username, m.age) from Member m", MemberDto.class)
               .getResultList();
